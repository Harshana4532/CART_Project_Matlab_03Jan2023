function [YY_LD,YY_HD]=pareto_model_synN_variable_KD_only_13dec2022(k, Kph, N_hd, A, mu, sig, kon, koff, np, hil)
warning('off')

global  cal lambR calR2 minS binS maxS KD YY_LD YY_HD cutoff_time
