%%%%%  Objective function for Constitutive High Affinity data fitting
...
alpmu=alp; % mean for initial LN T cell distribution w.r.t. R 
...
yF=[(mYY)./dat_scal_ConH, (meanTR1)./divOm_Ha, ((stdTR1)./divOs_Ha)]'; % for Weighted Cost function
