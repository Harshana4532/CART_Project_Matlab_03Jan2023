%%%%%  Objective function for synN Low Affinity data fitting

function [yF]=objective_model_all_synN_LD_CI_deathTf_ODE45_SYNCONS_CONS_FinSL(x0)

global cutoff_time cal calR minS binS maxS  
global divOm_La_syn divOs_La_syn dat_scal_synL

divH1=1/cal; %scaling U distribution w.r.t. H;
divR1=1/calR; %scaling T distribution w.r.t. R;

%synN Low Affinity %Lysis
...
yF=[(mYY)./dat_scal_synL, (meanTR1)./divOm_La_syn', (stdTR1)./divOs_La_syn']'; % for Weighted Cost function
