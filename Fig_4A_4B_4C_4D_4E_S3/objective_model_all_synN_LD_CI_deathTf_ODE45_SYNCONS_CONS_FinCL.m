%%%%%  Objective function for Constitutive Low Affinity data fitting

function [yF]=objective_model_all_synN_LD_CI_deathTf_ODE45_SYNCONS_CONS_FinCL(x0)

global cutoff_time cal calR minS binS maxS 
global divOm_La divOs_La dat_scal_ConL

divH1=1/cal; %scaling U distribution w.r.t. H;
divR1=1/calR; %scaling T distribution w.r.t. R;

% Const. Low Affinity %Lysis
...
yF=[(mYY)./dat_scal_ConL, (meanTR1)./divOm_La, ((stdTR1)./divOs_La)]'; % for Weighted Cost function
